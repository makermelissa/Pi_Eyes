...
void *spiThreadFunc(void *data) {
	...
	for(;;) {
        ...
        end_time = clock();
        printf("SPI Write Thread elapsed: %f seconds\n", (double)(end_time - start_time) / CLOCKS_PER_SEC);
	}
	return NULL;
}
...
int main(int argc, char *argv[]) {
	...
	for(;;) {
        ...
        end_time = clock();
        printf("Crop Rects elapsed: %f seconds\n", (double)(end_time - start_time) / CLOCKS_PER_SEC);

	    start_time = clock();
    	// Sync up all threads; wait for prior transfers to finish
		pthread_barrier_wait(&barr);
        end_time = clock();
        printf("Sync Threads elapsed: %f seconds\n", (double)(end_time - start_time) / CLOCKS_PER_SEC);
        ...
        end_time = clock();
        printf("Pixel Window elapsed: %f seconds\n", (double)(end_time - start_time) / CLOCKS_PER_SEC);
        ...
        end_time = clock();
        printf("Data Write Thread elapsed: %f seconds\n", (double)(end_time - start_time) / CLOCKS_PER_SEC);
        ...
        end_time = clock();
        printf("Show FPS elapsed: %f seconds\n", (double)(end_time - start_time) / CLOCKS_PER_SEC);
